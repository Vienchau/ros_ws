...
(cl:in-package msgsrv_basics_p-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msgsrv_basics_p-msg:<RobotStatus> is deprecated: use msgsrv_basics_p-msg:RobotStatus instead.")))

(cl:ensure-generic-function 'motor1_rpm-val :lambda-list '(m))
(cl:defmethod motor1_rpm-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgsrv_basics_p-msg:motor1_rpm-val is deprecated.  Use msgsrv_basics_p-msg:motor1_rpm instead.")
  (motor1_rpm m))

(cl:ensure-generic-function 'motor2_rpm-val :lambda-list '(m))
(cl:defmethod motor2_rpm-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgsrv_basics_p-msg:motor2_rpm-val is deprecated.  Use msgsrv_basics_p-msg:motor2_rpm instead.")
  (motor2_rpm m))

(cl:ensure-generic-function 'motor3_rpm-val :lambda-list '(m))
(cl:defmethod motor3_rpm-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgsrv_basics_p-msg:motor3_rpm-val is deprecated.  Use msgsrv_basics_p-msg:motor3_rpm instead.")
  (motor3_rpm m))

(cl:ensure-generic-function 'motor4_rpm-val :lambda-list '(m))
(cl:defmethod motor4_rpm-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgsrv_basics_p-msg:motor4_rpm-val is deprecated.  Use msgsrv_basics_p-msg:motor4_rpm instead.")
  (motor4_rpm m))

(cl:ensure-generic-function 'locn-val :lambda-list '(m))
(cl:defmethod locn-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msgsrv_basics_p-msg:locn-val is deprecated.  Use msgsrv_basics_p-msg:locn instead.")
  (locn m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RobotStatus>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'locn) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotStatus>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'locn) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RobotStatus>))
  (cl:+ 0
     ...
     2
     2
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'locn))
))
