...
// (in-package msgsrv_basics_p.msg)
...
class RobotStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('locn')) {
        this.locn = initObj.locn
      }
      else {
        this.locn = new geometry_msgs.msg.Vector3();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [locn]
    bufferOffset = geometry_msgs.msg.Vector3.serialize(obj.locn, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [locn]
    data.locn = geometry_msgs.msg.Vector3.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'msgsrv_basics_p/RobotStatus';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '22150532422434a03f7a1cd36a74be74';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.locn !== undefined) {
      resolved.locn = geometry_msgs.msg.Vector3.Resolve(msg.locn)
    }
    else {
      resolved.locn = new geometry_msgs.msg.Vector3()
    }
